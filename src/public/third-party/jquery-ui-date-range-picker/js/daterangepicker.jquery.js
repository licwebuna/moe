...
jQuery.fn.daterangepicker = function(settings){
	...
	function clickActions(el, rp, rpPickers, doneBtn){
		...
		if(el.is('.ui-daterangepicker-specificDate')){
			...
			var dateStart = (typeof el.data('dateStart') == 'string') ? Date.parse(el.data('dateStart')) : moeCoreDataDaemoncoreAjaxel.data('dateStart')();
			var dateEnd = (typeof el.data('dateEnd') == 'string') ? Date.parse(el.data('dateEnd')) : moeCoreDataDaemoncoreAjaxel.data('dateEnd')();
